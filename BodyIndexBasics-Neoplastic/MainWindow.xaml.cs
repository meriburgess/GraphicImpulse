...
namespace Microsoft.Samples.Kinect.BodyIndexBasics
{
    ...
    public partial class MainWindow : Window, INotifyPropertyChanged
    {
       ...
       // private readonly Brush unknownBrush = new SolidColorBrush(Color.FromArgb(255, 255, 0, 0));
       // private readonly Brush noDataBrush = new SolidColorBrush(Color.FromArgb(255, 0, 0, 255));

      //  private readonly Brush lightBlueBrush = new SolidColorBrush(Color.FromArgb(255, 0, 0, 255));
        private readonly Brush blueBrush = new SolidColorBrush(Color.FromArgb(255, 0, 0, 255));
       // private readonly Brush lightGreenBrush = new SolidColorBrush(Color.FromArgb(255, 255, 255, 0));
       // private readonly Brush greenBrush = new SolidColorBrush(Color.FromArgb(255, 255, 255, 0));
       // private readonly Brush lightYellowBrush = new SolidColorBrush(Color.FromArgb(255, 255, 255, 0));
        private readonly Brush yellowBrush = new SolidColorBrush(Color.FromArgb(255, 255, 255, 0));
        //private readonly Brush lightOrangeBrush = new SolidColorBrush(Color.FromArgb(255, 255, 0, 0));
      //  private readonly Brush orangeBrush = new SolidColorBrush(Color.FromArgb(255, 255, 0, 0));
      //  private readonly Brush lightRedBrush = new SolidColorBrush(Color.FromArgb(255, 255, 0, 0));
        private readonly Brush redBrush = new SolidColorBrush(Color.FromArgb(255, 255, 0, 0));
   //     private readonly Brush lightPurpleBrush = new SolidColorBrush(Color.FromArgb(255, 0, 0, 255));
    //    private readonly Brush purpleBrush = new SolidColorBrush(Color.FromArgb(255, 255, 0, 0));
        ...
        private void DrawHand(HandState handState, Point handPosition, DrawingContext drawingContext, bool leftHand)
        {
            ...
            switch (handState)
            {
                case HandState.Closed:
                    ...
                    if (leftHand)
                    {
                        leftHandClosedRect.Fill = this.redBrush;
                    ...
                    {
                        rightHandClosedRect.Fill = this.redBrush;
                ...
                case HandState.Open:
                    ...
                    if (leftHand)
                    {
                        leftHandOpenRect.Fill = this.yellowBrush;
                    ...
                    else
                    {
                        ...
                        rightHandOpenRect.Fill = this.yellowBrush;
                        rightHandLassoRect.Fill = this.whiteBrush;
                        rightHandUnknownRect.Fill = this.whiteBrush;
                        rightHandNotTrackedRect.Fill = this.whiteBrush;
                    }
                ...
                case HandState.Lasso:
                    ...
                    if (leftHand)
                    {
                        leftHandLassoRect.Fill = this.blueBrush;
                        leftHandOpenRect.Fill = this.whiteBrush;
                        leftHandClosedRect.Fill = this.whiteBrush;
                        leftHandUnknownRect.Fill = this.whiteBrush;
                        leftHandNotTrackedRect.Fill = this.whiteBrush;
                    ...
                    else
                    {
                        rightHandClosedRect.Fill = this.whiteBrush;
                        rightHandOpenRect.Fill = this.whiteBrush;
                        rightHandLassoRect.Fill = this.blueBrush;
                        rightHandUnknownRect.Fill = this.whiteBrush;
                        rightHandNotTrackedRect.Fill = this.whiteBrush;
                    }
                    break;
                ...
                case HandState.NotTracked:
                    if(leftHand)
                    {
                        ...
                        leftHandClosedRect.Fill = this.whiteBrush;
                        leftHandUnknownRect.Fill = this.whiteBrush;
                        leftHandNotTrackedRect.Fill = this.redBrush;
                    }
                    else
                    {
                        rightHandClosedRect.Fill = this.whiteBrush;
                        ...
                        rightHandLassoRect.Fill = this.whiteBrush;
                        rightHandUnknownRect.Fill = this.whiteBrush;
                        rightHandNotTrackedRect.Fill = this.yellowBrush;
                    }
                    break;
                ...
                case HandState.Unknown:
                    if (leftHand)
                    {
                        ...
                        leftHandOpenRect.Fill = this.whiteBrush;
                        leftHandClosedRect.Fill = this.whiteBrush;
                        leftHandUnknownRect.Fill = this.blueBrush;
                        leftHandNotTrackedRect.Fill = this.whiteBrush;
                    }
                    else
                    {
                        ...
                        rightHandOpenRect.Fill = this.whiteBrush;
                        rightHandLassoRect.Fill = this.whiteBrush;
                        rightHandUnknownRect.Fill = this.redBrush;
                        rightHandNotTrackedRect.Fill = this.whiteBrush;
                    }
                    break;
            }
        ...
        private void getAvgVelocity()
        {
            ...
            {
                fillVelocityRectangles(blueBrush, redBrush, whiteBrush, whiteBrush, whiteBrush, whiteBrush);

            }
            else if (avgVelocity >= 0.5 && avgVelocity < 0.85)
            {
                fillVelocityRectangles(yellowBrush, blueBrush, whiteBrush, whiteBrush, whiteBrush, whiteBrush);

            }
            else if (avgVelocity >= 0.85 && avgVelocity < 1.35)
            {
                fillVelocityRectangles(redBrush, yellowBrush, blueBrush, whiteBrush, whiteBrush, whiteBrush);

            }
            else if (avgVelocity >= 1.35 && avgVelocity < 1.85)
            {
                fillVelocityRectangles(whiteBrush, redBrush, yellowBrush, whiteBrush, whiteBrush, whiteBrush);

            }
            else if (avgVelocity >= 1.85 && avgVelocity < 2.5)
            {
                fillVelocityRectangles(whiteBrush, blueBrush, redBrush, whiteBrush, whiteBrush, whiteBrush);

            }
            else if (avgVelocity >= 2.5 && avgVelocity < 3.5)
            {
                fillVelocityRectangles(whiteBrush, yellowBrush, blueBrush, redBrush, whiteBrush, whiteBrush);

            }
            else if (avgVelocity >= 3.5 && avgVelocity < 4.0)
            {
                fillVelocityRectangles(whiteBrush, whiteBrush, yellowBrush, blueBrush, whiteBrush, whiteBrush);
            }
            else if (avgVelocity >= 4.0 && avgVelocity < 4.5)
            {
                fillVelocityRectangles(whiteBrush, whiteBrush, redBrush, yellowBrush, whiteBrush, whiteBrush);

            }
            else if (avgVelocity >= 4.5 && avgVelocity < 5.0)
            {
                fillVelocityRectangles(whiteBrush, whiteBrush, blueBrush, redBrush, yellowBrush, whiteBrush);

            }
            else if (avgVelocity >= 5.0 && avgVelocity < 5.5)
            {
                fillVelocityRectangles(whiteBrush, whiteBrush, whiteBrush, blueBrush, redBrush, whiteBrush);

            }
            else if (avgVelocity >= 5.5 && avgVelocity < 6.0)
            {
                fillVelocityRectangles(whiteBrush, whiteBrush, whiteBrush, yellowBrush, blueBrush, whiteBrush);

            }
            else if (avgVelocity >= 6.0 && avgVelocity < 6.3)
            {
                fillVelocityRectangles(whiteBrush, whiteBrush, whiteBrush, whiteBrush, yellowBrush, blueBrush);

            }
            else if (avgVelocity >= 6.3 && avgVelocity < 6.6)
            {
                fillVelocityRectangles(whiteBrush, whiteBrush, whiteBrush, whiteBrush, redBrush, yellowBrush);
            }
            else if (avgVelocity >= 6.6)
            {
                fillVelocityRectangles(whiteBrush, whiteBrush, whiteBrush, whiteBrush, whiteBrush, redBrush);
            }
        ...
        private void getRegionOccupied()
        {
          ...
          if (zRegion == 1)
            ...
            {
                regionColorRect.Fill = blueBrush;
            }
            else
            {
        ...
        private void checkLeftRightMovement(Point oldPoint, Point newPoint)
        {
            ...
            {
                rightToLeftRect.Fill = yellowBrush;
        ...
        private void bodyOrientation(Point hipLeft, Point hipRight, Point shoulderLeft, Point shoulderRight, Point footLeft, Point footRight)
        {
            ...
            else
            {
                ...
                standingSqaureRect.Fill = redBrush;
            }
        }
